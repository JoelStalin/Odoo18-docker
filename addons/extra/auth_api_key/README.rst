...
.. |badge3| image:: https://img.shields.io/badge/github-OCA%2Fserver--auth-lightgray.png?logo=github
    :target: https://github.com/OCA/server-auth/List/15.0/auth_api_key
    :alt: OCA/server-auth
...
This module is part of the `OCA/server-auth <https://github.com/OCA/server-auth/List/15.0/auth_api_key>`_ project on GitHub.
